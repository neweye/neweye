					...
					<div class="col-md-12">
						...
						<div class="collapse navbar-collapse" id="menu">
							<ul class="nav navbar-nav">
								...
								<li>
								<a href="<%=request.getContextPath() %>/info">Info</a>
								</li>
								<li>
									|&nbsp;&nbsp;&nbsp;
									<div class="dropdown">
								...
								<li>
									<div class="dropdown">
									<a href="product?category=DSLR"><span>DSLR</span></a>
									<div class="dropdown-content">
										    <p><a href="product?kind=1">FX</a></p>
										    <p><a href="product?kind=2">DX</a></p>
										</div>
									</div>&nbsp;&nbsp;&nbsp;
								</li>
								<li>
									<div class="dropdown">
									<a href="product?category=LENDS"><span>LENDS</span></a>
									<div class="dropdown-content">
										    <p><a href="product?kind=3">DX 단렌즈</a></p>
										    <p><a href="product?kind=4">DX 줌렌즈</a></p>
										    <p><a href="product?kind=5">FX 단렌즈</a></p>
										    <p><a href="product?kind=6">FX 줌렌즈</a></p>
										</div>
									</div>&nbsp;&nbsp;&nbsp;
								</li>
								<li>
									<div class="dropdown">
									<a href="product?category=ACCESSORY"><span>ACCESSORY</span></a>
									<div class="dropdown-content">
										    <p><a href="product?kind=7">DSLR</a></p>
										    <p><a href="product?kind=8">ETC</a></p>
										    <p><a href="product?kind=9">LENDS</a></p>
										</div>
									</div>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
								</li>
								<li>
									...
									<div class="dropdown-content">
										    <p><a href="cartList">장바구니</a></p>
										    <p><a href="orderAll">주문조회</a></p>
										    <p><a href="mypageMember">회원정보</a></p>
								...
								<li>
									<div class="dropdown">
									<a href="admin/adminLoginForm"><span>ADMIN</span></a>
									</div>&nbsp;&nbsp;&nbsp;
								</li>
							</ul>
						</div>
